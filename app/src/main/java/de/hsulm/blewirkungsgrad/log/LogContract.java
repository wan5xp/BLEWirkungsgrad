...
public class LogContract {
     ...
     */
    public static final String AUTHORITY = "de.hsulm.blewirkungsgrad.log";
    /**
    ...
    public final static class Log implements BaseColumns, LogColumns {
         ...
         */
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/de.hsulm.blewirkungsgrad.enties";
        /**
         * The MIME type of a {@link Session#CONTENT_URI} subdirectory of a single log entry.
         */
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/de.hsulm.blewirkungsgrad.entry";
         ...
         * @param number the session number. Numbers are incremented automatically for each key starting from 1 when creating new session.
         * @return the {@link Uri} that can be used to read log entries from
         */
    ...
    public final static class Session implements BaseColumns, SessionColumns {
         ...
         */
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/de.hsulm.blewirkungsgrad.sessions";
        /**
         * The MIME type of a {@link #CONTENT_URI} subdirectory of a single log session.
         */
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/de.hsulm.blewirkungsgrad.session";
    ...
    public final static class Application implements BaseColumns, ApplicationColumns {
         ...
         */
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/de.hsulm.blewirkungsgrad.applications";
        /**
         * The MIME type of a {@link #CONTENT_URI} sub-directory of a single application.
         */
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/de.hsulm.blewirkungsgrad.application";
