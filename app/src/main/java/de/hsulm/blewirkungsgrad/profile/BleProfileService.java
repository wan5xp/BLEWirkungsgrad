...
public abstract class BleProfileService extends Service implements BleManagerCallbacks {
     ...
     */
    public static final String EXTRA_DEVICE_ADDRESS = "de.hsulm.blewirkungsgrad.EXTRA_DEVICE_ADDRESS";
    /**
     * The key for the device name that is returned in {@link #BROADCAST_CONNECTION_STATE} with state {@link #STATE_CONNECTED}.
     */
    public static final String EXTRA_DEVICE_NAME = "de.hsulm.blewirkungsgrad.EXTRA_DEVICE_NAME";
    public static final String EXTRA_DEVICE = "de.hsulm.blewirkungsgrad.EXTRA_DEVICE";
    public static final String EXTRA_LOG_URI = "de.hsulm.blewirkungsgrad.EXTRA_LOG_URI";
    ...
    public void onBondingRequired(final BluetoothDevice device) {
        showToast(de.hsulm.blewirkungsgrad.R.string.bonding);
    ...
    public void onBonded(final BluetoothDevice device) {
        showToast(de.hsulm.blewirkungsgrad.R.string.bonded);
